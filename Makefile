...
# Template: subdirs
# Command: /usr/bin/qmake-qt5 -o Makefile qmake-gtest.pro
#############################################################################
...
DISTDIR = /home/02/eakuznec/test/gtest-master/.tmp/qmake-gtest1.0.0
SUBTARGETS    =  \
		sub-app \
		sub-tests
...
sub-app-qmake_all:  FORCE
	...
	cd app/ && $(QMAKE) -o Makefile /home/02/eakuznec/test/gtest-master/app/app.pro
	cd app/ && $(MAKE) -f Makefile qmake_all
sub-app: FORCE
	@test -d app/ || mkdir -p app/
	cd app/ && ( test -e Makefile || $(QMAKE) -o Makefile /home/02/eakuznec/test/gtest-master/app/app.pro ) && $(MAKE) -f Makefile
...
sub-app-all-ordered: FORCE
	@test -d app/ || mkdir -p app/
	cd app/ && ( test -e Makefile || $(QMAKE) -o Makefile /home/02/eakuznec/test/gtest-master/app/app.pro ) && $(MAKE) -f Makefile all
sub-app-all: FORCE
	@test -d app/ || mkdir -p app/
	cd app/ && ( test -e Makefile || $(QMAKE) -o Makefile /home/02/eakuznec/test/gtest-master/app/app.pro ) && $(MAKE) -f Makefile all
sub-app-clean-ordered: FORCE
	@test -d app/ || mkdir -p app/
	cd app/ && ( test -e Makefile || $(QMAKE) -o Makefile /home/02/eakuznec/test/gtest-master/app/app.pro ) && $(MAKE) -f Makefile clean
sub-app-clean: FORCE
	@test -d app/ || mkdir -p app/
	cd app/ && ( test -e Makefile || $(QMAKE) -o Makefile /home/02/eakuznec/test/gtest-master/app/app.pro ) && $(MAKE) -f Makefile clean
sub-app-distclean-ordered: FORCE
	@test -d app/ || mkdir -p app/
	cd app/ && ( test -e Makefile || $(QMAKE) -o Makefile /home/02/eakuznec/test/gtest-master/app/app.pro ) && $(MAKE) -f Makefile distclean
sub-app-distclean: FORCE
	@test -d app/ || mkdir -p app/
	cd app/ && ( test -e Makefile || $(QMAKE) -o Makefile /home/02/eakuznec/test/gtest-master/app/app.pro ) && $(MAKE) -f Makefile distclean
sub-app-install_subtargets-ordered: FORCE
	@test -d app/ || mkdir -p app/
	cd app/ && ( test -e Makefile || $(QMAKE) -o Makefile /home/02/eakuznec/test/gtest-master/app/app.pro ) && $(MAKE) -f Makefile install
sub-app-install_subtargets: FORCE
	@test -d app/ || mkdir -p app/
	cd app/ && ( test -e Makefile || $(QMAKE) -o Makefile /home/02/eakuznec/test/gtest-master/app/app.pro ) && $(MAKE) -f Makefile install
sub-app-uninstall_subtargets-ordered: FORCE
	@test -d app/ || mkdir -p app/
	cd app/ && ( test -e Makefile || $(QMAKE) -o Makefile /home/02/eakuznec/test/gtest-master/app/app.pro ) && $(MAKE) -f Makefile uninstall
sub-app-uninstall_subtargets: FORCE
	@test -d app/ || mkdir -p app/
	cd app/ && ( test -e Makefile || $(QMAKE) -o Makefile /home/02/eakuznec/test/gtest-master/app/app.pro ) && $(MAKE) -f Makefile uninstall
sub-tests-qmake_all: sub-app-qmake_all FORCE
	@test -d tests/ || mkdir -p tests/
	cd tests/ && $(QMAKE) -o Makefile /home/02/eakuznec/test/gtest-master/tests/tests.pro
	cd tests/ && $(MAKE) -f Makefile qmake_all
sub-tests: FORCE
	@test -d tests/ || mkdir -p tests/
	cd tests/ && ( test -e Makefile || $(QMAKE) -o Makefile /home/02/eakuznec/test/gtest-master/tests/tests.pro ) && $(MAKE) -f Makefile
...
sub-tests-all-ordered: sub-app-all-ordered  FORCE
	@test -d tests/ || mkdir -p tests/
	cd tests/ && ( test -e Makefile || $(QMAKE) -o Makefile /home/02/eakuznec/test/gtest-master/tests/tests.pro ) && $(MAKE) -f Makefile all
sub-tests-all: FORCE
	@test -d tests/ || mkdir -p tests/
	cd tests/ && ( test -e Makefile || $(QMAKE) -o Makefile /home/02/eakuznec/test/gtest-master/tests/tests.pro ) && $(MAKE) -f Makefile all
sub-tests-clean-ordered: sub-app-clean-ordered  FORCE
	@test -d tests/ || mkdir -p tests/
	cd tests/ && ( test -e Makefile || $(QMAKE) -o Makefile /home/02/eakuznec/test/gtest-master/tests/tests.pro ) && $(MAKE) -f Makefile clean
sub-tests-clean: FORCE
	@test -d tests/ || mkdir -p tests/
	cd tests/ && ( test -e Makefile || $(QMAKE) -o Makefile /home/02/eakuznec/test/gtest-master/tests/tests.pro ) && $(MAKE) -f Makefile clean
sub-tests-distclean-ordered: sub-app-distclean-ordered  FORCE
	@test -d tests/ || mkdir -p tests/
	cd tests/ && ( test -e Makefile || $(QMAKE) -o Makefile /home/02/eakuznec/test/gtest-master/tests/tests.pro ) && $(MAKE) -f Makefile distclean
sub-tests-distclean: FORCE
	@test -d tests/ || mkdir -p tests/
	cd tests/ && ( test -e Makefile || $(QMAKE) -o Makefile /home/02/eakuznec/test/gtest-master/tests/tests.pro ) && $(MAKE) -f Makefile distclean
sub-tests-install_subtargets-ordered: sub-app-install_subtargets-ordered  FORCE
	@test -d tests/ || mkdir -p tests/
	cd tests/ && ( test -e Makefile || $(QMAKE) -o Makefile /home/02/eakuznec/test/gtest-master/tests/tests.pro ) && $(MAKE) -f Makefile install
sub-tests-install_subtargets: FORCE
	@test -d tests/ || mkdir -p tests/
	cd tests/ && ( test -e Makefile || $(QMAKE) -o Makefile /home/02/eakuznec/test/gtest-master/tests/tests.pro ) && $(MAKE) -f Makefile install
sub-tests-uninstall_subtargets-ordered: sub-app-uninstall_subtargets-ordered  FORCE
	@test -d tests/ || mkdir -p tests/
	cd tests/ && ( test -e Makefile || $(QMAKE) -o Makefile /home/02/eakuznec/test/gtest-master/tests/tests.pro ) && $(MAKE) -f Makefile uninstall
sub-tests-uninstall_subtargets: FORCE
	@test -d tests/ || mkdir -p tests/
	cd tests/ && ( test -e Makefile || $(QMAKE) -o Makefile /home/02/eakuznec/test/gtest-master/tests/tests.pro ) && $(MAKE) -f Makefile uninstall

Makefile: qmake-gtest.pro /usr/lib64/qt5/mkspecs/linux-g++/qmake.conf /usr/lib64/qt5/mkspecs/features/spec_pre.prf \
...
sub-app-check_ordered:
	@test -d app/ || mkdir -p app/
	cd app/ && ( test -e Makefile || $(QMAKE) -o Makefile /home/02/eakuznec/test/gtest-master/app/app.pro ) && $(MAKE) -f Makefile check
sub-tests-check_ordered: sub-app-check_ordered 
	@test -d tests/ || mkdir -p tests/
	cd tests/ && ( test -e Makefile || $(QMAKE) -o Makefile /home/02/eakuznec/test/gtest-master/tests/tests.pro ) && $(MAKE) -f Makefile check
check: sub-app-check_ordered sub-tests-check_ordered

sub-app-benchmark_ordered:
	@test -d app/ || mkdir -p app/
	cd app/ && ( test -e Makefile || $(QMAKE) -o Makefile /home/02/eakuznec/test/gtest-master/app/app.pro ) && $(MAKE) -f Makefile benchmark
sub-tests-benchmark_ordered: sub-app-benchmark_ordered 
	@test -d tests/ || mkdir -p tests/
	cd tests/ && ( test -e Makefile || $(QMAKE) -o Makefile /home/02/eakuznec/test/gtest-master/tests/tests.pro ) && $(MAKE) -f Makefile benchmark
